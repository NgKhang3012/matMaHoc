...
public class ChoreDataAccess
{
    ...
    {
        var usersCollection = ConnectToMongo<PersonModel>(UserCollection);
    ...
    public async Task<List<ChoreModel>> GetAllChoresForAUser(PersonModel user)
    {
        var choresCollection = ConnectToMongo<ChoreModel>(ChoreCollection);
    ...
    public Task CreateUser(PersonModel user)
    {
        var usersCollection = ConnectToMongo<PersonModel>(UserCollection);
